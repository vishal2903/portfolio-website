...
const PROJECTS = [
  {
    ...
    bullets: [
      "Flagship voice AI powering 100xEngineers' education delivery — cuts mentor lesson-prep from hours to under 3 minutes, reducing workload by 80% across live cohort programs",
      "Slashed per-output AI cost by 87% with a deterministic Python engine across 15+ typed templates — production-grade, near-zero failures at scale",
      "Shipped as open-source MCP servers for Claude Desktop and building a public MCP app store for the community — same RAG pipeline at zero API cost, actively growing developer adoption",
    ],
  ...
  },
  {
    ...
    bullets: [
      "Company's AI Chief of Staff — 7 specialized agents run research, hiring, and content pipelines fully unattended, reclaiming 20+ hrs/week of leadership bandwidth",
      "Adapts to leadership over time: agents carry evolving memory and identity files, letting the CTO reprogram directives and add pipelines without rebuilding infrastructure",
      "Self-healing by design — auto-recovers failures across daily AI research, resume screening, and cross-platform publishing",
    ],
  ...
  },
  {
    ...
    bullets: [
      "Solo-built the company's commercial ticketing platform on Next.js + Supabase from scratch — 100,000+ visitors in launch week, zero downtime",
      "$15k+ in revenue within 7 days · became the company's primary lead acquisition channel",
    ],
  ...
  },
  {
    ...
    bullets: [
      "Always-on cohort support agent — resolves 89.6% of 1,000+ monthly student queries autonomously so mentors focus on teaching, not answering",
      "Self-improving: every query feeds confusion signals back into lesson planning via FAISS semantic matching — zero extra cost",
      "Single process at $25/month — 50% cheaper than a two-service deployment",
    ],
